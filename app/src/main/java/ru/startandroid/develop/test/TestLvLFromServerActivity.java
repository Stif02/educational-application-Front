...
import ru.startandroid.develop.test.service.CourseWorkService;
import ru.startandroid.develop.test.service.RequestService;

public class TestLvLFromServerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TestLvLFromServerActivity that = this;
        Future<String> future = executorService.submit(() -> {
            QSelectOutOfFour qSelectOutOfFour2 = that.requestService.getQSelectOutOfFour(3);
