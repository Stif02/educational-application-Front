...
public class LvLactivity6 extends Activity {
        ...
        answerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (levelmany.answerString.equals(editText.getText().toString())) {
                    ...
                    h.postDelayed(ChangeActivityEnd,3000);
                } else {
    ...
    public void changeActivityEnd() {
        Intent myIntentEnd= new Intent(this, LvLactivityEnd.class);
        startActivity(myIntentEnd);
        finish();
    }
    Runnable ChangeActivityEnd = new Runnable() {
        public void run() {
            changeActivityEnd();
        }
    };
