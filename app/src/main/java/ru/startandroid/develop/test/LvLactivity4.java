...
public class LvLactivity4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri uri4 = Uri.parse(levelpic.variant1);
        variant1Button.setImageURI(uri4);
        ...
        Uri uri5 = Uri.parse(levelpic.variant2);
        variant2Button.setImageURI(uri5);
        ...
        Uri uri6 = Uri.parse(levelpic.variant3);
        variant3Button.setImageURI(uri6);
        ...
        variant1Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (levelpic.answerString.equals("1")) {
                    ...
                    h.postDelayed(ChangeActivity5,3000);
                } else {
    ...
    Runnable ChangeActivity5 = new Runnable() {
        public void run() {
            changeActivity5();
        }
    };
